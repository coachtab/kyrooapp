...
const t = {
  en: {
    ...
    plan_desc_FAT_LOSS:      'Strip body fat without starving yourself. Mix of strength training (to keep muscle) and varied cardio (to burn calories) — all calibrated to your level, schedule, and equipment.',
    plan_desc_HYPERTROPHY:   'Build real muscle with the classic Push/Pull/Legs split and progressive overload. Each week you lift a little more than the last. Anchored on heavy compound lifts plus targeted isolation for your weakest muscle group.',
    plan_desc_TRANSFORMATION:'A holistic 90-day body recomposition in three phases: build the base, combine fat loss with muscle gain, then peak for maximum definition. The most ambitious plan in the catalog.',
    plan_desc_FIRST_STEPS:   'Your very first training plan. Learn the 5 foundational patterns (squat, hinge, push, pull, carry) in short confident sessions. No gym experience, no intimidation, no wasted time — just results.',
    plan_desc_NO_GYM:        'Zero equipment, zero excuses. Bodyweight-only progressions that fit in any space — hotel room, dorm, living room. Master push-ups, squats, and planks, then level up to advanced variations.',
    plan_desc_POOL:          'Proper structured swim training. Every session has a warm-up, technique drills, a main interval set, and a cool-down. Matches your stroke preference and ability — from learning to competitive.',
    plan_desc_RACE_READY:    'Purpose-built for Hyrox — 8 km of running split by 8 fitness stations. Learn each station, then combine them at race pace, then run full simulations. Periodised for your race date.',
    plan_desc_HALF_OR_FULL:  'Classic marathon periodisation with Easy runs, Tempo runs, Intervals, and one Long Run per week. Half or full — either distance. Built on your current running volume with a proper taper.',
    plan_desc_FUNCTIONAL:    'CrossFit-style training. Each session starts with strength or a gymnastics skill, then ends with a high-intensity WOD (AMRAP / EMOM / For Time). Targets your weakest area for extra work.',
    plan_desc_HIGH_INTENSITY:'Maximum effect, minimum time. Rotating HIIT formats — Tabata, EMOM, AMRAP, and classic 30/30 intervals. 15-45 minute sessions that shred calories and build cardio fast.',
  ...
  de: {
    ...
    plan_desc_FAT_LOSS:      'Körperfett verlieren, ohne zu hungern. Ein Mix aus Krafttraining (erhält Muskeln) und abwechslungsreichem Cardio (verbrennt Kalorien) — abgestimmt auf dein Level, deinen Zeitplan und dein Equipment.',
    plan_desc_HYPERTROPHY:   'Echten Muskelaufbau mit dem klassischen Push/Pull/Beine-Split und progressivem Overload. Jede Woche hebst du etwas mehr als in der letzten. Verankert in schweren Grundübungen plus gezielter Isolation für deine schwächste Muskelgruppe.',
    plan_desc_TRANSFORMATION:'Eine ganzheitliche 90-Tage-Körpertransformation in drei Phasen: Basis aufbauen, Fettabbau mit Muskelaufbau verbinden, dann für maximale Definition peaken. Der ehrgeizigste Plan im Katalog.',
    plan_desc_FIRST_STEPS:   'Dein allererster Trainingsplan. Lerne die 5 Grundmuster (Kniebeuge, Hüftbeugung, Drücken, Ziehen, Tragen) in kurzen, selbstbewussten Einheiten. Keine Erfahrung, keine Hemmungen, keine verschwendete Zeit — nur Ergebnisse.',
    plan_desc_NO_GYM:        'Null Equipment, null Ausreden. Nur-Körpergewicht-Progressionen, die in jeden Raum passen — Hotelzimmer, Wohnung, Wohnzimmer. Meistere Liegestütze, Kniebeugen und Planks, dann steigere dich auf fortgeschrittene Varianten.',
    plan_desc_POOL:          'Strukturiertes Schwimmtraining. Jede Einheit hat Warm-up, Technik-Drills, ein Hauptintervall-Set und Cool-down. Passt zu deinem bevorzugten Schwimmstil und Niveau — vom Einsteiger bis zum Wettkampf.',
    plan_desc_RACE_READY:    'Speziell für Hyrox — 8 km Laufen, aufgeteilt durch 8 Fitness-Stationen. Lerne jede Station, kombiniere sie im Renntempo, laufe dann volle Simulationen. Periodisiert für deinen Renntermin.',
    plan_desc_HALF_OR_FULL:  'Klassische Marathon-Periodisierung mit Easy-Runs, Tempoläufen, Intervallen und einem Long Run pro Woche. Halb oder ganz — beide Distanzen. Aufbauend auf deinem aktuellen Laufumfang mit korrektem Taper.',
    plan_desc_FUNCTIONAL:    'Training im CrossFit-Stil. Jede Einheit beginnt mit Kraft oder einer Turnübung und endet mit einem hochintensiven WOD (AMRAP / EMOM / For Time). Fokussiert deine Schwachstelle mit zusätzlichem Volumen.',
    plan_desc_HIGH_INTENSITY:'Maximale Wirkung, minimale Zeit. Wechselnde HIIT-Formate — Tabata, EMOM, AMRAP und klassische 30/30-Intervalle. 15-45 Minuten Einheiten, die Kalorien verbrennen und Cardio schnell aufbauen.',
