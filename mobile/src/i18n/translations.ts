...
const t = {
  en: {
    ...
    home_headline_1:  'Your plan. ',
    home_headline_2:  'Your rules.',
    home_headline_3:  '',
    ...
    plans_filter_hypertrophy: 'Muscle',
    ...
    plan_name_FAT_LOSS:      'Burn Fat',
    plan_name_HYPERTROPHY:   'Build Muscle',
    plan_name_TRANSFORMATION:'90-Day Transform',
    plan_name_FIRST_STEPS:   'First Steps',
    plan_name_NO_GYM:        'Home Workout',
    plan_name_POOL:          'Swim Fit',
    plan_name_RACE_READY:    'Hyrox Prep',
    plan_name_HALF_OR_FULL:  'Marathon',
    plan_name_FUNCTIONAL:    'CrossFit Style',
    plan_name_HIGH_INTENSITY:'HIIT Cardio',
    plan_name_MOBILITY:      'Mobility',
    plan_name_CALISTHENICS:  'Calisthenics',
    plan_name_SPORT_PREP:    'Sport Prep',
    plan_name_ACTIVE_AGING:  'Active Aging',

    // ── Plan descriptions (keyed by category) ────────────────────────────
    plan_desc_FAT_LOSS:      'Lose body fat without going hungry. A mix of weight training (to keep your muscle) and varied running/cycling work (to burn calories) — all matched to your level, your time and the gear you own.',
    plan_desc_HYPERTROPHY:   'Grow real muscle with three workout types each week — push day (chest and arms), pull day (back and biceps), and leg day. Each week you lift a little more than the last, with extra work for your weakest area.',
    plan_desc_TRANSFORMATION:'A 90-day full-body change in three steps: build a strong base, lose fat while you build muscle, then tighten everything up. The most ambitious plan we offer.',
    plan_desc_FIRST_STEPS:   'Your very first training plan. Learn the 5 basic moves (squat, bend, push, pull, carry) in short, easy sessions. No gym needed, no pressure — just quick wins.',
    plan_desc_NO_GYM:        'No equipment, no excuses. Bodyweight-only moves that fit in any space — hotel room, dorm, living room. Start with push-ups, squats and planks, then step up to harder versions.',
    plan_desc_POOL:          'Real, structured swim training. Every session has a warm-up, technique drills, a main set and a cool-down. Matches your swimming style and level — from just learning to racing.',
    plan_desc_RACE_READY:    'Built for Hyrox — a race where you run 8 km broken up by 8 fitness stations. Learn each station, combine them at race speed, then run full practice races. Timed to peak on your race day.',
    plan_desc_HALF_OR_FULL:  'A classic marathon build-up with slow runs, faster runs, sprint sets and one long run per week. Half or full — you pick. Based on how much you run today, with a lighter final week before the race.',
    plan_desc_FUNCTIONAL:    'CrossFit-style training. Each session starts with a strength or bodyweight skill, then ends with a short, all-out finish. Extra focus on your weakest area.',
    plan_desc_HIGH_INTENSITY:'Maximum effect, minimum time. Short workouts (15–45 min) that mix short hard efforts with short rests. Burns calories and builds fitness fast.',
    plan_desc_MOBILITY:      'Daily stretching, yoga-style flows and easy recovery routines. Works on its own or next to any other plan. Fixes the slouching from sitting all day, loosens tight hips, and keeps you moving well as you age.',
    plan_desc_CALISTHENICS:  'Chase a specific bodyweight skill — muscle-up, handstand, front lever, one-arm pull-up. Unlike general bodyweight training, each week brings you a clear step closer to your target move.',
    plan_desc_SPORT_PREP:    'Sport-specific training for boxing, cycling, triathlon, climbing, jiu-jitsu and any team sport. Pick your sport, tell us when your season or competition starts, and Kyroo builds a full plan around it.',
    plan_desc_ACTIVE_AGING:  'Strength, balance and daily energy for active adults 55+. Focus on avoiding falls, stronger bones, healthy joints and staying independent. Supportive and upbeat — not clinical.',
  ...
  de: {
    ...
    home_headline_1:  'Dein Plan. ',
    home_headline_2:  'Deine Regeln.',
    home_headline_3:  '',
    ...
    plans_filter_hypertrophy: 'Muskeln',
    ...
    plan_name_FAT_LOSS:      'Fett verbrennen',
    plan_name_HYPERTROPHY:   'Muskeln aufbauen',
    plan_name_TRANSFORMATION:'90-Tage Umbau',
    plan_name_FIRST_STEPS:   'Erster Schritt',
    plan_name_NO_GYM:        'Home-Workout',
    plan_name_POOL:          'Schwimm-Fit',
    plan_name_RACE_READY:    'Hyrox-Vorbereitung',
    plan_name_HALF_OR_FULL:  'Marathon',
    plan_name_FUNCTIONAL:    'CrossFit-Style',
    plan_name_HIGH_INTENSITY:'HIIT Cardio',
    plan_name_MOBILITY:      'Beweglichkeit',
    plan_name_CALISTHENICS:  'Calisthenics',
    plan_name_SPORT_PREP:    'Sport-Vorbereitung',
    plan_name_ACTIVE_AGING:  'Aktiv im Alter',

    // ── Planbeschreibungen (nach Kategorie) ──────────────────────────────
    plan_desc_FAT_LOSS:      'Körperfett verlieren, ohne zu hungern. Ein Mix aus Krafttraining (behält deine Muskeln) und abwechslungsreichem Ausdauertraining (verbrennt Kalorien) — abgestimmt auf dein Level, deine Zeit und dein Equipment.',
    plan_desc_HYPERTROPHY:   'Echter Muskelaufbau mit drei Workout-Typen pro Woche — Druck-Tag (Brust und Arme), Zug-Tag (Rücken und Bizeps) und Bein-Tag. Jede Woche hebst du ein bisschen mehr als in der letzten, mit Extra-Arbeit für deine schwächste Stelle.',
    plan_desc_TRANSFORMATION:'Eine 90-Tage Komplett-Umstellung in drei Schritten: eine starke Basis aufbauen, Fett verlieren und gleichzeitig Muskeln aufbauen, dann alles definieren. Der ehrgeizigste Plan, den wir anbieten.',
    plan_desc_FIRST_STEPS:   'Dein allererster Trainingsplan. Lerne die 5 Grundbewegungen (Kniebeuge, Bücken, Drücken, Ziehen, Tragen) in kurzen, leichten Einheiten. Kein Gym nötig, kein Druck — nur schnelle Erfolge.',
    plan_desc_NO_GYM:        'Kein Equipment, keine Ausreden. Nur-Körpergewicht-Übungen, die in jeden Raum passen — Hotelzimmer, Wohnung, Wohnzimmer. Starte mit Liegestützen, Kniebeugen und Planks, steigere dich dann zu schwereren Varianten.',
    plan_desc_POOL:          'Echtes, strukturiertes Schwimmtraining. Jede Einheit hat Aufwärmen, Technik-Übungen, ein Haupt-Set und ein Auslaufen. Passt zu deinem Schwimmstil und Level — vom Einsteiger bis zum Wettkampf.',
    plan_desc_RACE_READY:    'Gebaut für Hyrox — ein Rennen, bei dem du 8 km läufst, unterbrochen von 8 Fitness-Stationen. Lerne jede Station, kombiniere sie im Renntempo, laufe dann volle Testrennen. Getimt für deinen Renntag.',
    plan_desc_HALF_OR_FULL:  'Klassischer Marathon-Aufbau mit langsamen Läufen, schnelleren Läufen, Sprint-Sets und einem langen Lauf pro Woche. Halb oder ganz — du wählst. Aufbauend auf deinem aktuellen Laufumfang, mit einer leichteren Woche vor dem Rennen.',
    plan_desc_FUNCTIONAL:    'Training im CrossFit-Stil. Jede Einheit beginnt mit einer Kraft- oder Körpergewicht-Übung und endet mit einem kurzen, harten Finale. Extra-Fokus auf deine Schwachstelle.',
    plan_desc_HIGH_INTENSITY:'Maximale Wirkung, minimale Zeit. Kurze Einheiten (15–45 Min), die kurze harte Belastungen mit kurzen Pausen mischen. Verbrennt Kalorien und baut Ausdauer schnell auf.',
    plan_desc_MOBILITY:      'Tägliches Dehnen, Yoga-Flows und einfache Regenerationsroutinen. Funktioniert alleine oder neben einem anderen Plan. Löst Verspannungen vom langen Sitzen, lockert enge Hüften und hält dich ein Leben lang beweglich.',
    plan_desc_CALISTHENICS:  'Lerne eine bestimmte Körpergewicht-Fähigkeit — Muscle-up, Handstand, Front Lever, einarmige Klimmzüge. Anders als normales Körpergewicht-Training bringt dich jede Woche einen klaren Schritt näher an deine Zielübung.',
    plan_desc_SPORT_PREP:    'Sportspezifisches Training für Boxen, Radfahren, Triathlon, Klettern, Jiu-Jitsu und jede Mannschaftssportart. Wähle deine Sportart, sag uns wann deine Saison oder dein Wettkampf startet — Kyroo baut einen kompletten Plan drumherum.',
    plan_desc_ACTIVE_AGING:  'Kraft, Balance und Alltagsenergie für aktive Erwachsene ab 55. Fokus auf Stürze vermeiden, stärkere Knochen, gesunde Gelenke und Selbstständigkeit. Motivierend und stärkend — nicht klinisch.',
