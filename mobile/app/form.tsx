...
const EN: Record<string, Step[]> = {
  ...
  'FAT LOSS': [
    ...
    { key: 'days_per_week', question: 'Days available', questionAccent: 'to train?', type: 'slider', min: 2, max: 6, unit: ' days' },
  ...
  'FIRST STEPS': [
    ...
    { key: 'days_per_week', question: 'Days available', questionAccent: 'to train?', type: 'slider', min: 2, max: 4, unit: ' days' },
  ...
  'POOL': [
    ...
    { key: 'days_per_week', question: 'Days available', questionAccent: 'to train?', type: 'slider', min: 2, max: 5, unit: ' days' },
  ...
  'MOBILITY': [
    ...
    { key: 'days_per_week', question: 'Days available', questionAccent: 'to train?', type: 'slider', min: 2, max: 7, unit: ' days' },
    { key: 'injuries',      question: 'Any pain or', questionAccent: 'injuries?', type: 'iconSelect', multi: true, exclusiveNone: true, iconOptions: INJURIES_EN },
  ],
  ...
  'ACTIVE AGING': [
    ...
    { key: 'focus_area', question: 'What to', questionAccent: 'improve?',
      hint: 'Pick any that apply',
      type: 'iconSelect', multi: true,
      iconOptions: [
        { label: 'Balance',  icon: 'swap-horizontal-outline' },
        { label: 'Legs',     icon: 'walk-outline'            },
        { label: 'Back',     icon: 'body-outline'            },
        { label: 'Core',     icon: 'accessibility-outline'   },
        { label: 'Arms',     icon: 'barbell-outline'         },
        { label: 'Wrists',   icon: 'hand-right-outline'      },
        { label: 'Shoulders',icon: 'hand-left-outline'       },
        { label: 'Hips',     icon: 'footsteps-outline'       },
        { label: 'Fitness',  icon: 'pulse-outline'           },
      ]},
    { key: 'days_per_week', question: 'Days available', questionAccent: 'to train?', type: 'slider', min: 2, max: 5, unit: ' days' },
...
const DE: Record<string, Step[]> = {
  ...
  'FAT LOSS': [
    ...
    { key: 'days_per_week', question: 'Wie viele Tage', questionAccent: 'zum Trainieren?', type: 'slider', min: 2, max: 6, unit: ' Tage' },
  ...
  'FIRST STEPS': [
    ...
    { key: 'days_per_week', question: 'Wie viele Tage', questionAccent: 'zum Trainieren?', type: 'slider', min: 2, max: 4, unit: ' Tage' },
  ...
  'POOL': [
    ...
    { key: 'days_per_week', question: 'Wie viele Tage', questionAccent: 'zum Trainieren?', type: 'slider', min: 2, max: 5, unit: ' Tage' },
  ...
  'MOBILITY': [
    ...
    { key: 'days_per_week', question: 'Wie viele Tage', questionAccent: 'zum Trainieren?', type: 'slider', min: 2, max: 7, unit: ' Tage' },
    { key: 'injuries',      question: 'Schmerzen oder', questionAccent: 'Verletzungen?', type: 'iconSelect', multi: true, exclusiveNone: true, iconOptions: INJURIES_DE },
  ],
  ...
  'ACTIVE AGING': [
    ...
    { key: 'focus_area', question: 'Was', questionAccent: 'verbessern?',
      hint: 'Mehrfachauswahl möglich',
      type: 'iconSelect', multi: true,
      iconOptions: [
        { label: 'Balance',      icon: 'swap-horizontal-outline' },
        { label: 'Beine',        icon: 'walk-outline'            },
        { label: 'Rücken',       icon: 'body-outline'            },
        { label: 'Rumpf',        icon: 'accessibility-outline'   },
        { label: 'Arme',         icon: 'barbell-outline'         },
        { label: 'Handgelenke',  icon: 'hand-right-outline'      },
        { label: 'Schultern',    icon: 'hand-left-outline'       },
        { label: 'Hüften',       icon: 'footsteps-outline'       },
        { label: 'Fitness',      icon: 'pulse-outline'           },
      ]},
    { key: 'days_per_week', question: 'Wie viele Tage', questionAccent: 'zum Trainieren?', type: 'slider', min: 2, max: 5, unit: ' Tage' },
