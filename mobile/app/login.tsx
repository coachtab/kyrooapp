    ...
    <SafeAreaView style={s.safe}>
      ...
      <ScrollView contentContainerStyle={s.scroll} keyboardShouldPersistTaps="handled">
        <View style={s.header}>
          ...
          <Text style={s.title}>{tr('login_title')}</Text>
        </View>
        <Divider label={tr('login_divider')} />
        <View style={s.form}>
          <View>
          ...
          <View>
            ...
            <TextInput style={s.input} placeholder={tr('login_password')} placeholderTextColor={colors.muted} value={password} onChangeText={setPassword} secureTextEntry onSubmitEditing={submit} />
          </View>
          <TouchableOpacity onPress={() => router.push('/reset')} style={{ alignSelf: 'flex-end' }}>
        ...
        <View style={s.socials}>
          <TouchableOpacity style={s.social}><Text style={s.socialText}>{tr('login_apple')}</Text></TouchableOpacity>
          <TouchableOpacity style={s.social}><Text style={s.socialText}>{tr('login_google')}</Text></TouchableOpacity>
        </View>
        <Text style={s.footer}>{tr('login_footer')}{'  '}
